...
## Define the name and size and local file location of DSM Provider VM
```
...
## Define the name and size and local file location of DSM Agent VM
```
...
## Configure roles and variables for deploying DSM Provider & Agent VM
```
...
## Configure roles and variables for destroying DSM Provider & Agent VM
```
