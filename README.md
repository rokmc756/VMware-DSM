...
## Defind all variables for VMware DSM Provider & Agent VMs
```
...
## Configure roles and variables to deploy VMware DSM Provider & Agent VM
```
...
## Configure roles and variables to destroy VMware DSM Provider & Agent VM
```
